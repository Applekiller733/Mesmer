...
namespace SongAppApi.Migrations
{
    ...
    [Migration("20260517114134_AddPlaylistVisibility")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SongAppApi.Entities.Friendship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SongAppApi.Entities.PlaylistInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlaylistId", "ReceiverId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SongAppApi.Entities.Friendship", b =>
                {
                    b.HasOne("SongAppApi.Entities.Account", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SongAppApi.Entities.Account", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("SongAppApi.Entities.PlaylistInvitation", b =>
                {
                    b.HasOne("SongAppApi.Entities.Playlist", "Playlist")
                        .WithMany()
